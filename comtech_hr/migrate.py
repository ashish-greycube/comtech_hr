...
def after_migrate():
    custom_fields = {
        ...
        "Company" : [
            ...
            dict(
                fieldname = "custom_default_ticket_expense_due_account",
                fieldtype = "Link",
                options = "Account",
                label =  _("Default Ticket Expense Due Account"),
            ...
            dict(
                ...
                insert_after = "custom_default_ticket_expense_due_account",
                is_custom_field = 1,
                is_system_generated = 0,
            ),
            dict(
                fieldname = "custom_default_extra_payment_due_account",
                fieldtype = "Link",
                options = "Account",
                label =  _("Default Extra Payment Due Account"),
            ...
            dict(
                ...
                insert_after = "custom_default_extra_payment_expense_account",
                is_custom_field = 1,
                is_system_generated = 0,
            ),
            dict(
                ...
                insert_after = "custom_default_extra_payment_due_account",
                is_custom_field = 1,
                is_system_generated = 0,
            )
        ],
